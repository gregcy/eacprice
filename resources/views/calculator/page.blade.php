        ...
        <div class="bg-blue-700 w-full">
            <div class="max-w-6xl m-auto p-5">
                <div class="w-full justify-between flex">
                    @if ($currentLocale == 'el')
                    <span class="ml-auto"><a href="/en/" class="text-white "><img class="h-5 ml-[5px]" src="/images/gb.png" allt="English">{{ __('English') }}</a></span>
                    ...
                    <span class="ml-5"><a href="/el/" class="text-white"><img class="h-5 ml-1.5" src="/images/gr.png" alt="Greek">{{ __('Greek') }}</a></span>
                    @endif
                </div>
